...
import { Mail, MessageCircle, Menu, X, ChevronRight, ChevronLeft, BookOpen } from 'lucide-react';

const sectionImages = {
  read: "https://images.unsplash.com/photo-1457369804613-52c61a468e7d?auto=format&fit=crop&q=80&w=1920",
  quotes: "https://images.unsplash.com/photo-1490633874781-1c63cc424610?auto=format&fit=crop&q=80&w=1920",
  contact: "https://images.unsplash.com/photo-1470071459604-3b5ec3a7fe05?auto=format&fit=crop&q=80&w=1920"
};
...
function App() {
  ...
  const [currentChapter, setCurrentChapter] = useState('א׳');
  ...
  const chapters = Object.keys(chapterContent);
    ...
    <div className="min-h-screen">
        ...
        <div className="max-w-7xl mx-auto px-4">
          <div className="flex justify-between items-center h-16">
            ...
            <div className="hidden md:flex space-x-8">
              <a href="#home" className="text-gray-900 hover:text-gray-600 px-3 py-2 font-body">דף הבית</a>
              <a href="#read" className="text-gray-900 hover:text-gray-600 px-3 py-2 font-body">לקריאת החיבור</a>
              <a href="#contact" className="text-gray-900 hover:text-gray-600 px-3 py-2 font-body">צור קשר</a>
            </div>
        ...
        {isMenuOpen && (
          <div className="md:hidden">
            <div className="px-2 pt-2 pb-3 space-y-1 sm:px-3 bg-white">
              <a href="#home" className="block px-3 py-2 text-gray-900 hover:bg-gray-100 font-body">דף הבית</a>
              <a href="#read" className="block px-3 py-2 text-gray-900 hover:bg-gray-100 font-body">לקריאת החיבור</a>
              <a href="#contact" className="block px-3 py-2 text-gray-900 hover:bg-gray-100 font-body">צור קשר</a>
            </div>
          </div>
        )}
      </nav>
      ...
      <div id="home" className="relative h-screen">
        ...
        <div className="relative h-full flex flex-col items-center justify-center text-center text-white px-4">
          ...
          <p className="text-lg mb-2 font-body">מבוסס על תורתו של המגיד ממעזריש</p>
          <p className="text-lg mb-12 font-body">(ספר דיגיטלי לקריאה)</p>
          
          <div className="mb-12">
            <div className="transition-opacity duration-500">
              <p className="text-xl font-body mb-2">{quotes[currentQuoteIndex].text}</p>
              <p className="text-sm font-body">{quotes[currentQuoteIndex].chapter}</p>
            </div>
          </div>
      ...
      <div id="read" className="relative page-transition">
        ...
        <div className="relative py-32 px-6">
          <div className="max-w-6xl mx-auto">
            <h2 className="text-3xl font-heading text-center mb-16 text-white">לקריאת החיבור</h2>
            <div className="bg-white rounded-2xl shadow-lg p-16">
              <div className="flex justify-between items-center mb-10">
                <h3 className="text-3xl font-heading">{'פרק ' + currentChapter}</h3>
        ...
        <div className="relative py-20 px-4">
          <div className="max-w-4xl mx-auto">
            <div className="bg-gray-900 text-white rounded-2xl shadow-lg p-8 text-center">
              <p className="text-2xl font-body mb-4">{quotes[currentQuoteIndex].text}</p>
              <footer className="text-gray-300 font-body">{quotes[currentQuoteIndex].chapter}</footer>
            </div>
          </div>
        </div>
      </div>
      ...
      <footer className="bg-gray-900 text-white py-4 text-center">
        <div className="font-body space-y-2">
          ...
          <p className="text-sm">אין להעתיק, לשכפל או לצלם ללא רשות מפורשת של המחברת</p>
        </div>
      </footer>
    </div>
  );
